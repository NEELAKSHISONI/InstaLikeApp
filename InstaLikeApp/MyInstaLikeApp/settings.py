"""
Django settings for InstaLikeApp project.
...
SECRET_KEY = 'django-insecure-7nb76_h56+$z(9=9ggn9(dxgazvrglpses%xl@07$lg^bvj#n+'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            os.path.join(BASE_DIR, 'InstaLikeApp', 'templates')
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
